...
DRAWABLES = {
    ...
    # Icons for the Android Auto root tabs: Liked, Playlists, Stations
    # (Material "favorite" / "queue_music" / "radio", Apache-2.0).
    "cassette_root_liked": "M12,21.35l-1.45,-1.32C5.4,15.36 2,12.28 2,8.5 2,5.42 4.42,3 7.5,3c1.74,0 3.41,0.81 4.5,2.09C13.09,3.81 14.76,3 16.5,3 19.58,3 22,5.42 22,8.5c0,3.78 -3.4,6.86 -8.55,11.54L12,21.35z",
    "cassette_root_playlists": "M15,6L3,6v2h12L15,6zM15,10L3,10v2h12v-2zM3,16h8v-2L3,14v2zM17,6v8.18C16.69,14.07 16.35,14 16,14c-1.66,0 -3,1.34 -3,3s1.34,3 3,3 3,-1.34 3,-3L19,6h3L22,4h-5v2z",
    "cassette_root_stations": "M3.24,6.15C2.51,6.43 2,7.17 2,8v12c0,1.1 0.9,2 2,2h16c1.11,0 2,-0.89 2,-2L22,8c0,-1.11 -0.89,-2 -2,-2L8.3,6l8.47,-3.38 0.78,1.94L20,3.25 17.93,0 6.19,4.63c-0.51,0.2 -1.02,0.5 -1.53,0.8zM20,20L4,20L4,12h16v8zM8,14c-1.1,0 -2,0.9 -2,2s0.9,2 2,2 2,-0.9 2,-2 -0.9,-2 -2,-2z",
}
